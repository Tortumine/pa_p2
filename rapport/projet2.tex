...
Comme on peut le remarquer sur la figure 2, l'implémentation de la de la structure en arbre a une croissance très lente et qui devient linéaire au delà de la taille 800 (figure 4) . Si on prends en compte que ne nombre d'élément géré par l'union find croit avec le carré de la taille du labyrinthe. La complexité presque linéaire est vérifié
\end{document}
